...
namespace DotWars.Higher.Levels
{
    ...
    internal class Dotapedia
    {
        private readonly Vector2 picturePos;
        private readonly Vector2 ingamePos;

        private readonly Sprite commander;
        private readonly Sprite juggernaut;
        private readonly Sprite gunner;
        private readonly Sprite bombardier;
        private readonly Sprite medic;
        private readonly Sprite specialist;
        private readonly Sprite sniper;
        private readonly Sprite grunt;
        private readonly Sprite suicide;

        private readonly Sprite commanderInGame;
        private readonly Sprite soldierInGame;

        public String[] unitTypes { get; set; }
        public Info[] soldierInfo { get; set; }
        public Info[] commanderInfo { get; set; }

        private readonly int unitMax;
        private readonly int soldierMax;
        private readonly int commanderMax;
