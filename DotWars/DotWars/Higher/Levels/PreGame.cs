...
namespace DotWars
{
    public class PreGame : Level
    {
            ...
            : base(null, new Dictionary<Type, int>(), Vector2.Zero, loadedTextures, audio)
        {
            ...
            Vector2 picturePos = new Vector2(1030, 376);
            ...
            assassinsTips[1] = new Tip("Not only does Aquoes's ability slow enemies,\nbut it also heals himself and his allies.", new DOTS[] { DOTS.AQUOES });
            ...
            deathmatchTips[1] = new Tip("Rockets explode, and can take out\nmany allied units at once. Beware the Specialist.", new DOTS[] { DOTS.SPECIALIST });
            deathmatchTips[2] = new Tip("The Medic heals nearby allies.", new DOTS[] { DOTS.MEDIC });
            deathmatchTips[3] = new Tip("The Bombardier calls in devastating air strikes.\nWhen you hear the static, raise your eyes to the skies.", new DOTS[] { DOTS.BOMBARDIER });
            ...
            deathmatchTips[6] = new Tip("The Juggernaut will try to act as a shield for his allies.\nDispatch them by tossing grenades behind them.", new DOTS[] { DOTS.JUGGERNAUT });
        ...
        public override void Draw(Microsoft.Xna.Framework.Graphics.SpriteBatch sB, GraphicsDeviceManager gM)
        {
            ...
            textures.DrawString(sB, ((timer <= beginTime) ? "Press Start To Begin!" : (int)Math.Ceiling(timer) + ""), new Vector2(1037, 600), Color.White, TextureManager.FontSizes.small);
